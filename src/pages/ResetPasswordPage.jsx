    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--app-bg)] text-[var(--app-text)] selection:bg-[var(--app-accent)] selection:text-[var(--app-bg)]">
        ...
        <main className="relative z-10 w-full max-w-md px-6 py-12 text-center">
          <div className="w-16 h-16 mx-auto mb-6 rounded-full border-2 border-[var(--app-accent)] flex items-center justify-center text-[var(--app-accent)]">
            <span className="material-symbols-outlined text-4xl">check</span>
          </div>
          <h2 className="font-headline text-3xl font-semibold text-[var(--app-accent)] mb-4">
            Password Reset
          </h2>
          <p className="font-manrope text-base text-[var(--app-text-muted)] mb-8">
    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--app-bg)] text-[var(--app-text)] selection:bg-[var(--app-accent)] selection:text-[var(--app-bg)]">
      ...
      <main className="relative z-10 w-full max-w-md px-6 py-12">
        <div className="afu flex flex-col items-center mb-8 text-center">
          ...
          <h1 className="font-headline text-[32px] leading-[40px] font-bold tracking-widest uppercase text-[var(--app-accent)] mb-1">
            Reset Password
          </h1>
          {email && (
            <p className="font-manrope text-sm text-[var(--app-text-muted)]">for {email}</p>
          )}
        </div>
        ...
        <section className="afu2 bg-[var(--app-surface)] backdrop-blur-md rounded-xl p-6 border border-[var(--app-border)] shadow-2xl">
          <form className="space-y-4" onSubmit={handleSubmit} noValidate>
            ...
            {formError ? (
              <p className="font-manrope text-sm text-[var(--app-danger)] px-1 pt-2" role="alert">
                {formError}
              </p>
            ) : null}
